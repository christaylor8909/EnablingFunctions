...
if file_path:
    ...
    print(f"\n✅ Created forecast accuracy table with {len(accuracy_df)} rows")

    # Export to Excel
    excel_output_path = "forecast_accuracy_all_crops.xlsx"
    accuracy_df.to_excel(excel_output_path, index=False)
    print(f"\n📁 Saved full results to '{excel_output_path}'")
