...
# Define AOI as a WKT polygon (example: a small box near London)
FOOTPRINT_WKT = "POLYGON((-0.1 51.5, -0.1 51.6, 0.0 51.6, 0.0 51.5, -0.1 51.5))"
...
print("✅ Modeling complete. You can now refine labels and export results.")